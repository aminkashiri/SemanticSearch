...
from scout_goat_env import ScoutGoatEnv
from scout_goat_agent import ScoutGoatAgent
...
@click.option(
    "--config",
    default="projects/real_world_goat/configs/real_world_goat_eval.yaml",
    help="Path to configuration YAML file",
)
@click.option(
    "--task-config",
    default="projects/real_world_goat/configs/example_tasks.json",
